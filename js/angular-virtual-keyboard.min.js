...
var VKI = function(customConfig, layout, deadKeys, keyInputCallback) {
  ...
  this.VKI_deadkeysOn = config.deadkeysOn !== undefined ? config.deadkeysOn : false;  // Turn dead keys on by default
  ...
  this.VKI_clickOnly = config.clickOnly || false;
